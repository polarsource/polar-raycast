 ...
 * Authorize
 */
async function oauth2Authorize(client, options) {
    ...
    const [result] = await M.match(M.json(200, operations.Oauth2AuthorizeResponseOauth2Authorize$inboundSchema), M.fail(["4XX", "5XX"]))(response);
    if (!result.ok) {
        return result;
    }
    return result;
