 ...
 * List custom fields.
 */
async function customFieldsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CustomFieldsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.CustomFieldsListResponse$inboundSchema, {
        key: "Result",
