...
export declare class Checkouts extends ClientSDK {
     ...
     */
    create(request: components.CheckoutLegacyCreate, options?: RequestOptions): Promise<components.CheckoutLegacy>;
    /**
     * Get Checkout
     *
     * @remarks
     ...
     */
    get(request: operations.CheckoutsGetRequest, options?: RequestOptions): Promise<components.CheckoutLegacy>;
}
