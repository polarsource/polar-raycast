...
exports.benefitBaseToJSON = benefitBaseToJSON;
exports.benefitBaseFromJSON = benefitBaseFromJSON;
...
function benefitBaseToJSON(benefitBase) {
    return JSON.stringify(exports.BenefitBase$outboundSchema.parse(benefitBase));
}
function benefitBaseFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.BenefitBase$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitBase' from JSON`);
}
