...
exports.pledgeToJSON = pledgeToJSON;
exports.pledgeFromJSON = pledgeFromJSON;
...
function pledgeToJSON(pledge) {
    return JSON.stringify(exports.Pledge$outboundSchema.parse(pledge));
}
function pledgeFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.Pledge$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Pledge' from JSON`);
}
