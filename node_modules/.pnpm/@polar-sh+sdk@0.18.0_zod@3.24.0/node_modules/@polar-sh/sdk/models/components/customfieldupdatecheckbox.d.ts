...
export declare const CustomFieldUpdateCheckboxType: {
    readonly Checkbox: "checkbox";
};
export type CustomFieldUpdateCheckboxType = ClosedEnum<typeof CustomFieldUpdateCheckboxType>;
/**
...
/** @internal */
export declare const CustomFieldUpdateCheckboxType$inboundSchema: z.ZodNativeEnum<typeof CustomFieldUpdateCheckboxType>;
/** @internal */
export declare const CustomFieldUpdateCheckboxType$outboundSchema: z.ZodNativeEnum<typeof CustomFieldUpdateCheckboxType>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CustomFieldUpdateCheckboxType$ {
