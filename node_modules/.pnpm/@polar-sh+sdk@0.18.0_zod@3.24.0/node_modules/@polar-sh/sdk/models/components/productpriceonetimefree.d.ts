...
export declare function productPriceOneTimeFreeToJSON(productPriceOneTimeFree: ProductPriceOneTimeFree): string;
export declare function productPriceOneTimeFreeFromJSON(jsonString: string): SafeParseResult<ProductPriceOneTimeFree, SDKValidationError>;
