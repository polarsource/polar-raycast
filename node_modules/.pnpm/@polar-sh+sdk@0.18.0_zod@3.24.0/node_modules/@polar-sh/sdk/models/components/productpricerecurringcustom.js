...
function productPriceRecurringCustomToJSON(productPriceRecurringCustom) {
    return JSON.stringify(exports.ProductPriceRecurringCustom$outboundSchema.parse(productPriceRecurringCustom));
}
function productPriceRecurringCustomFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceRecurringCustom$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceRecurringCustom' from JSON`);
}
