...
export declare function productPriceOneTimeToJSON(productPriceOneTime: ProductPriceOneTime): string;
export declare function productPriceOneTimeFromJSON(jsonString: string): SafeParseResult<ProductPriceOneTime, SDKValidationError>;
