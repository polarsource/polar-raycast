...
exports.oAuth2ClientToJSON = oAuth2ClientToJSON;
exports.oAuth2ClientFromJSON = oAuth2ClientFromJSON;
...
function oAuth2ClientToJSON(oAuth2Client) {
    return JSON.stringify(exports.OAuth2Client$outboundSchema.parse(oAuth2Client));
}
function oAuth2ClientFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.OAuth2Client$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OAuth2Client' from JSON`);
}
