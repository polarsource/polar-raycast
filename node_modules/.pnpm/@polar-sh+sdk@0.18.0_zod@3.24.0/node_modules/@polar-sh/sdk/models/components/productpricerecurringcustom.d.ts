...
export declare function productPriceRecurringCustomToJSON(productPriceRecurringCustom: ProductPriceRecurringCustom): string;
export declare function productPriceRecurringCustomFromJSON(jsonString: string): SafeParseResult<ProductPriceRecurringCustom, SDKValidationError>;
