...
exports.downloadableFileCreateFromJSON = downloadableFileCreateFromJSON;
...
function downloadableFileCreateFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.DownloadableFileCreate$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'DownloadableFileCreate' from JSON`);
}
