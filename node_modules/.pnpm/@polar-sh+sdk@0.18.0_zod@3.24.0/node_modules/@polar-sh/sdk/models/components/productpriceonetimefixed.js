...
exports.productPriceOneTimeFixedToJSON = productPriceOneTimeFixedToJSON;
exports.productPriceOneTimeFixedFromJSON = productPriceOneTimeFixedFromJSON;
...
function productPriceOneTimeFixedToJSON(productPriceOneTimeFixed) {
    return JSON.stringify(exports.ProductPriceOneTimeFixed$outboundSchema.parse(productPriceOneTimeFixed));
}
function productPriceOneTimeFixedFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceOneTimeFixed$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceOneTimeFixed' from JSON`);
}
