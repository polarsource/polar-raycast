...
/** @internal */
exports.ProductPriceRecurringFree$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ProductPriceRecurringFree$;
(function (ProductPriceRecurringFree$) {
    /** @deprecated use `ProductPriceRecurringFree$inboundSchema` instead. */
    ProductPriceRecurringFree$.inboundSchema = exports.ProductPriceRecurringFree$inboundSchema;
    /** @deprecated use `ProductPriceRecurringFree$outboundSchema` instead. */
    ProductPriceRecurringFree$.outboundSchema = exports.ProductPriceRecurringFree$outboundSchema;
})(ProductPriceRecurringFree$ || (exports.ProductPriceRecurringFree$ = ProductPriceRecurringFree$ = {}));
function productPriceRecurringFreeToJSON(productPriceRecurringFree) {
    return JSON.stringify(exports.ProductPriceRecurringFree$outboundSchema.parse(productPriceRecurringFree));
}
function productPriceRecurringFreeFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceRecurringFree$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceRecurringFree' from JSON`);
}
//# sourceMappingURL=productpricerecurringfree.js.map