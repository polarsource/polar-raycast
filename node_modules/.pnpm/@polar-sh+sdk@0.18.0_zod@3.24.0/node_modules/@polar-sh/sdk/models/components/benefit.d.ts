...
export type Benefit = BenefitAds | BenefitDiscord | BenefitGitHubRepository | BenefitDownloadables | BenefitLicenseKeys | BenefitCustom;
/** @internal */
export declare const Benefit$inboundSchema: z.ZodType<Benefit, z.ZodTypeDef, unknown>;
/** @internal */
export type Benefit$Outbound = BenefitAds$Outbound | BenefitDiscord$Outbound | BenefitGitHubRepository$Outbound | BenefitDownloadables$Outbound | BenefitLicenseKeys$Outbound | BenefitCustom$Outbound;
/** @internal */
