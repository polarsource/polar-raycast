...
/** @internal */
exports.ProductPriceRecurringFreeCreate$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ProductPriceRecurringFreeCreate$;
(function (ProductPriceRecurringFreeCreate$) {
    /** @deprecated use `ProductPriceRecurringFreeCreate$inboundSchema` instead. */
    ProductPriceRecurringFreeCreate$.inboundSchema = exports.ProductPriceRecurringFreeCreate$inboundSchema;
    /** @deprecated use `ProductPriceRecurringFreeCreate$outboundSchema` instead. */
    ProductPriceRecurringFreeCreate$.outboundSchema = exports.ProductPriceRecurringFreeCreate$outboundSchema;
})(ProductPriceRecurringFreeCreate$ || (exports.ProductPriceRecurringFreeCreate$ = ProductPriceRecurringFreeCreate$ = {}));
function productPriceRecurringFreeCreateToJSON(productPriceRecurringFreeCreate) {
    return JSON.stringify(exports.ProductPriceRecurringFreeCreate$outboundSchema.parse(productPriceRecurringFreeCreate));
}
function productPriceRecurringFreeCreateFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceRecurringFreeCreate$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceRecurringFreeCreate' from JSON`);
}
//# sourceMappingURL=productpricerecurringfreecreate.js.map