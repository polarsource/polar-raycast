...
/** @internal */
exports.ProductPriceRecurringFixedCreate$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ProductPriceRecurringFixedCreate$;
(function (ProductPriceRecurringFixedCreate$) {
    /** @deprecated use `ProductPriceRecurringFixedCreate$inboundSchema` instead. */
    ProductPriceRecurringFixedCreate$.inboundSchema = exports.ProductPriceRecurringFixedCreate$inboundSchema;
    /** @deprecated use `ProductPriceRecurringFixedCreate$outboundSchema` instead. */
    ProductPriceRecurringFixedCreate$.outboundSchema = exports.ProductPriceRecurringFixedCreate$outboundSchema;
})(ProductPriceRecurringFixedCreate$ || (exports.ProductPriceRecurringFixedCreate$ = ProductPriceRecurringFixedCreate$ = {}));
function productPriceRecurringFixedCreateToJSON(productPriceRecurringFixedCreate) {
    return JSON.stringify(exports.ProductPriceRecurringFixedCreate$outboundSchema.parse(productPriceRecurringFixedCreate));
}
function productPriceRecurringFixedCreateFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceRecurringFixedCreate$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceRecurringFixedCreate' from JSON`);
}
//# sourceMappingURL=productpricerecurringfixedcreate.js.map