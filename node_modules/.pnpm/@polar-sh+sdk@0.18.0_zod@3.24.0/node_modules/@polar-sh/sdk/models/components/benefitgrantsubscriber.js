...
exports.benefitGrantSubscriberToJSON = benefitGrantSubscriberToJSON;
exports.benefitGrantSubscriberFromJSON = benefitGrantSubscriberFromJSON;
...
function benefitGrantSubscriberToJSON(benefitGrantSubscriber) {
    return JSON.stringify(exports.BenefitGrantSubscriber$outboundSchema.parse(benefitGrantSubscriber));
}
function benefitGrantSubscriberFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.BenefitGrantSubscriber$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitGrantSubscriber' from JSON`);
}
