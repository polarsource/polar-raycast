...
exports.licenseKeyReadToJSON = licenseKeyReadToJSON;
exports.licenseKeyReadFromJSON = licenseKeyReadFromJSON;
...
function licenseKeyReadToJSON(licenseKeyRead) {
    return JSON.stringify(exports.LicenseKeyRead$outboundSchema.parse(licenseKeyRead));
}
function licenseKeyReadFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.LicenseKeyRead$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'LicenseKeyRead' from JSON`);
}
