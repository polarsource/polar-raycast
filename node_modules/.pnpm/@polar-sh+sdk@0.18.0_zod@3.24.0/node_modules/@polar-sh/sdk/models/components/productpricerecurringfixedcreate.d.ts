...
/** @internal */
export declare const ProductPriceRecurringFixedCreate$outboundSchema: z.ZodType<ProductPriceRecurringFixedCreate$Outbound, z.ZodTypeDef, ProductPriceRecurringFixedCreate>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ProductPriceRecurringFixedCreate$ {
    /** @deprecated use `ProductPriceRecurringFixedCreate$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ProductPriceRecurringFixedCreate, z.ZodTypeDef, unknown>;
    /** @deprecated use `ProductPriceRecurringFixedCreate$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ProductPriceRecurringFixedCreate$Outbound, z.ZodTypeDef, ProductPriceRecurringFixedCreate>;
    /** @deprecated use `ProductPriceRecurringFixedCreate$Outbound` instead. */
    type Outbound = ProductPriceRecurringFixedCreate$Outbound;
}
export declare function productPriceRecurringFixedCreateToJSON(productPriceRecurringFixedCreate: ProductPriceRecurringFixedCreate): string;
export declare function productPriceRecurringFixedCreateFromJSON(jsonString: string): SafeParseResult<ProductPriceRecurringFixedCreate, SDKValidationError>;
//# sourceMappingURL=productpricerecurringfixedcreate.d.ts.map