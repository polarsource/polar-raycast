...
export declare function benefitGrantSubscriberToJSON(benefitGrantSubscriber: BenefitGrantSubscriber): string;
export declare function benefitGrantSubscriberFromJSON(jsonString: string): SafeParseResult<BenefitGrantSubscriber, SDKValidationError>;
