...
export declare function userOrderProductToJSON(userOrderProduct: UserOrderProduct): string;
export declare function userOrderProductFromJSON(jsonString: string): SafeParseResult<UserOrderProduct, SDKValidationError>;
