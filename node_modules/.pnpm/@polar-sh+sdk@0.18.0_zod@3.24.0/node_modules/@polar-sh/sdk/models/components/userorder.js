...
exports.userOrderToJSON = userOrderToJSON;
exports.userOrderFromJSON = userOrderFromJSON;
...
function userOrderToJSON(userOrder) {
    return JSON.stringify(exports.UserOrder$outboundSchema.parse(userOrder));
}
function userOrderFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.UserOrder$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserOrder' from JSON`);
}
