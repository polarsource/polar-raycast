...
export declare function productPriceRecurringFixedToJSON(productPriceRecurringFixed: ProductPriceRecurringFixed): string;
export declare function productPriceRecurringFixedFromJSON(jsonString: string): SafeParseResult<ProductPriceRecurringFixed, SDKValidationError>;
