...
/** @internal */
exports.ProductPriceOneTimeFree$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ProductPriceOneTimeFree$;
(function (ProductPriceOneTimeFree$) {
    /** @deprecated use `ProductPriceOneTimeFree$inboundSchema` instead. */
    ProductPriceOneTimeFree$.inboundSchema = exports.ProductPriceOneTimeFree$inboundSchema;
    /** @deprecated use `ProductPriceOneTimeFree$outboundSchema` instead. */
    ProductPriceOneTimeFree$.outboundSchema = exports.ProductPriceOneTimeFree$outboundSchema;
})(ProductPriceOneTimeFree$ || (exports.ProductPriceOneTimeFree$ = ProductPriceOneTimeFree$ = {}));
function productPriceOneTimeFreeToJSON(productPriceOneTimeFree) {
    return JSON.stringify(exports.ProductPriceOneTimeFree$outboundSchema.parse(productPriceOneTimeFree));
}
function productPriceOneTimeFreeFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceOneTimeFree$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceOneTimeFree' from JSON`);
}
//# sourceMappingURL=productpriceonetimefree.js.map