...
export declare function productPriceOneTimeCustomToJSON(productPriceOneTimeCustom: ProductPriceOneTimeCustom): string;
export declare function productPriceOneTimeCustomFromJSON(jsonString: string): SafeParseResult<ProductPriceOneTimeCustom, SDKValidationError>;
