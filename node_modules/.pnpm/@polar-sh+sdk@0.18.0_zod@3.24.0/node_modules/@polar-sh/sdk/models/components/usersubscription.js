...
exports.userSubscriptionToJSON = userSubscriptionToJSON;
exports.userSubscriptionFromJSON = userSubscriptionFromJSON;
...
function userSubscriptionToJSON(userSubscription) {
    return JSON.stringify(exports.UserSubscription$outboundSchema.parse(userSubscription));
}
function userSubscriptionFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.UserSubscription$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserSubscription' from JSON`);
}
