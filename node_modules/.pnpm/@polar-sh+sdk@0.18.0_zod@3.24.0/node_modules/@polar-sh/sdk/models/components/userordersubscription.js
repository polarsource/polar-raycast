...
exports.userOrderSubscriptionToJSON = userOrderSubscriptionToJSON;
exports.userOrderSubscriptionFromJSON = userOrderSubscriptionFromJSON;
...
function userOrderSubscriptionToJSON(userOrderSubscription) {
    return JSON.stringify(exports.UserOrderSubscription$outboundSchema.parse(userOrderSubscription));
}
function userOrderSubscriptionFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.UserOrderSubscription$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserOrderSubscription' from JSON`);
}
