...
function productPriceRecurringFixedToJSON(productPriceRecurringFixed) {
    return JSON.stringify(exports.ProductPriceRecurringFixed$outboundSchema.parse(productPriceRecurringFixed));
}
function productPriceRecurringFixedFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceRecurringFixed$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceRecurringFixed' from JSON`);
}
