...
exports.productPriceOneTimeCustomToJSON = productPriceOneTimeCustomToJSON;
exports.productPriceOneTimeCustomFromJSON = productPriceOneTimeCustomFromJSON;
...
function productPriceOneTimeCustomToJSON(productPriceOneTimeCustom) {
    return JSON.stringify(exports.ProductPriceOneTimeCustom$outboundSchema.parse(productPriceOneTimeCustom));
}
function productPriceOneTimeCustomFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceOneTimeCustom$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceOneTimeCustom' from JSON`);
}
