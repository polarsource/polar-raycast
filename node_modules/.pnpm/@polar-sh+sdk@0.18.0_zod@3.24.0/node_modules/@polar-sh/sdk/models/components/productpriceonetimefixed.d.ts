...
export declare function productPriceOneTimeFixedToJSON(productPriceOneTimeFixed: ProductPriceOneTimeFixed): string;
export declare function productPriceOneTimeFixedFromJSON(jsonString: string): SafeParseResult<ProductPriceOneTimeFixed, SDKValidationError>;
