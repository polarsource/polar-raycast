...
/** @internal */
exports.ProductPriceOneTimeFreeCreate$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ProductPriceOneTimeFreeCreate$;
(function (ProductPriceOneTimeFreeCreate$) {
    /** @deprecated use `ProductPriceOneTimeFreeCreate$inboundSchema` instead. */
    ProductPriceOneTimeFreeCreate$.inboundSchema = exports.ProductPriceOneTimeFreeCreate$inboundSchema;
    /** @deprecated use `ProductPriceOneTimeFreeCreate$outboundSchema` instead. */
    ProductPriceOneTimeFreeCreate$.outboundSchema = exports.ProductPriceOneTimeFreeCreate$outboundSchema;
})(ProductPriceOneTimeFreeCreate$ || (exports.ProductPriceOneTimeFreeCreate$ = ProductPriceOneTimeFreeCreate$ = {}));
function productPriceOneTimeFreeCreateToJSON(productPriceOneTimeFreeCreate) {
    return JSON.stringify(exports.ProductPriceOneTimeFreeCreate$outboundSchema.parse(productPriceOneTimeFreeCreate));
}
function productPriceOneTimeFreeCreateFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPriceOneTimeFreeCreate$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPriceOneTimeFreeCreate' from JSON`);
}
//# sourceMappingURL=productpriceonetimefreecreate.js.map