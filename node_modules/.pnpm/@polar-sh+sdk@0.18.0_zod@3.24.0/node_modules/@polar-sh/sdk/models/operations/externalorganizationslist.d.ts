...
export declare function externalOrganizationsListQueryParamOrganizationIDFilterToJSON(externalOrganizationsListQueryParamOrganizationIDFilter: ExternalOrganizationsListQueryParamOrganizationIDFilter): string;
export declare function externalOrganizationsListQueryParamOrganizationIDFilterFromJSON(jsonString: string): SafeParseResult<ExternalOrganizationsListQueryParamOrganizationIDFilter, SDKValidationError>;
/** @internal */
