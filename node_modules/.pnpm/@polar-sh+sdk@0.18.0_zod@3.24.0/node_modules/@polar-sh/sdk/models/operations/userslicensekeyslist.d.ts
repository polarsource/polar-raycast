...
export declare function usersLicenseKeysListQueryParamOrganizationIDFilterToJSON(usersLicenseKeysListQueryParamOrganizationIDFilter: UsersLicenseKeysListQueryParamOrganizationIDFilter): string;
export declare function usersLicenseKeysListQueryParamOrganizationIDFilterFromJSON(jsonString: string): SafeParseResult<UsersLicenseKeysListQueryParamOrganizationIDFilter, SDKValidationError>;
/** @internal */
...
export declare function usersLicenseKeysListRequestToJSON(usersLicenseKeysListRequest: UsersLicenseKeysListRequest): string;
export declare function usersLicenseKeysListRequestFromJSON(jsonString: string): SafeParseResult<UsersLicenseKeysListRequest, SDKValidationError>;
/** @internal */
...
export declare function usersLicenseKeysListResponseToJSON(usersLicenseKeysListResponse: UsersLicenseKeysListResponse): string;
export declare function usersLicenseKeysListResponseFromJSON(jsonString: string): SafeParseResult<UsersLicenseKeysListResponse, SDKValidationError>;
