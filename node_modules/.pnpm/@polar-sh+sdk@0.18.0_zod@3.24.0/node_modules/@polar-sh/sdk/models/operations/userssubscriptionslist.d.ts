...
export declare function usersSubscriptionsListQueryParamOrganizationIDFilterToJSON(usersSubscriptionsListQueryParamOrganizationIDFilter: UsersSubscriptionsListQueryParamOrganizationIDFilter): string;
export declare function usersSubscriptionsListQueryParamOrganizationIDFilterFromJSON(jsonString: string): SafeParseResult<UsersSubscriptionsListQueryParamOrganizationIDFilter, SDKValidationError>;
/** @internal */
...
export declare function usersSubscriptionsListRequestToJSON(usersSubscriptionsListRequest: UsersSubscriptionsListRequest): string;
export declare function usersSubscriptionsListRequestFromJSON(jsonString: string): SafeParseResult<UsersSubscriptionsListRequest, SDKValidationError>;
/** @internal */
...
export declare function usersSubscriptionsListResponseToJSON(usersSubscriptionsListResponse: UsersSubscriptionsListResponse): string;
export declare function usersSubscriptionsListResponseFromJSON(jsonString: string): SafeParseResult<UsersSubscriptionsListResponse, SDKValidationError>;
