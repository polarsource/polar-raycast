...
exports.externalOrganizationsListQueryParamOrganizationIDFilterToJSON = externalOrganizationsListQueryParamOrganizationIDFilterToJSON;
exports.externalOrganizationsListQueryParamOrganizationIDFilterFromJSON = externalOrganizationsListQueryParamOrganizationIDFilterFromJSON;
...
/** @internal */
exports.PlatformFilter$inboundSchema = z.union([
    components.Platforms$inboundSchema,
    z.array(components.Platforms$inboundSchema),
]);
/** @internal */
exports.PlatformFilter$outboundSchema = z.union([
...
/** @internal */
exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$inboundSchema = z.union([z.string(), z.array(z.string())]);
/** @internal */
exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$outboundSchema = z.union([z.string(), z.array(z.string())]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ExternalOrganizationsListQueryParamOrganizationIDFilter$;
(function (ExternalOrganizationsListQueryParamOrganizationIDFilter$) {
    /** @deprecated use `ExternalOrganizationsListQueryParamOrganizationIDFilter$inboundSchema` instead. */
    ExternalOrganizationsListQueryParamOrganizationIDFilter$.inboundSchema = exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$inboundSchema;
    /** @deprecated use `ExternalOrganizationsListQueryParamOrganizationIDFilter$outboundSchema` instead. */
    ExternalOrganizationsListQueryParamOrganizationIDFilter$.outboundSchema = exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$outboundSchema;
})(ExternalOrganizationsListQueryParamOrganizationIDFilter$ || (exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$ = ExternalOrganizationsListQueryParamOrganizationIDFilter$ = {}));
function externalOrganizationsListQueryParamOrganizationIDFilterToJSON(externalOrganizationsListQueryParamOrganizationIDFilter) {
    return JSON.stringify(exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$outboundSchema
        .parse(externalOrganizationsListQueryParamOrganizationIDFilter));
}
function externalOrganizationsListQueryParamOrganizationIDFilterFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ExternalOrganizationsListQueryParamOrganizationIDFilter$inboundSchema
        .parse(JSON.parse(x)), `Failed to parse 'ExternalOrganizationsListQueryParamOrganizationIDFilter' from JSON`);
}
/** @internal */
exports.ExternalOrganizationsListRequest$inboundSchema = z.object({
    ...
    sorting: z.nullable(z.array(components.ExternalOrganizationSortProperty$inboundSchema)).optional(),
}).transform((v) => {
...
exports.ExternalOrganizationsListRequest$outboundSchema = z.object({
    ...
    page: z.number().int().default(1),
    limit: z.number().int().default(10),
    sorting: z.nullable(z.array(components.ExternalOrganizationSortProperty$outboundSchema)).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
