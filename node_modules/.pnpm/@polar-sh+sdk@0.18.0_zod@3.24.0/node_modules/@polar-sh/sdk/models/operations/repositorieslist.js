...
exports.repositoriesListQueryParamOrganizationIDFilterToJSON = repositoriesListQueryParamOrganizationIDFilterToJSON;
exports.repositoriesListQueryParamOrganizationIDFilterFromJSON = repositoriesListQueryParamOrganizationIDFilterFromJSON;
...
function repositoriesListQueryParamOrganizationIDFilterToJSON(repositoriesListQueryParamOrganizationIDFilter) {
    return JSON.stringify(exports.RepositoriesListQueryParamOrganizationIDFilter$outboundSchema.parse(repositoriesListQueryParamOrganizationIDFilter));
}
function repositoriesListQueryParamOrganizationIDFilterFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.RepositoriesListQueryParamOrganizationIDFilter$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'RepositoriesListQueryParamOrganizationIDFilter' from JSON`);
}
/** @internal */
