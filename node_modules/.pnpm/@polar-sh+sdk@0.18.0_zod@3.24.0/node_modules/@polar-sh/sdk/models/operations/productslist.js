...
exports.ProductsListResponse$ = exports.ProductsListResponse$outboundSchema = exports.ProductsListResponse$inboundSchema = exports.ProductsListRequest$ = exports.ProductsListRequest$outboundSchema = exports.ProductsListRequest$inboundSchema = exports.QueryParamBenefitIDFilter$ = exports.QueryParamBenefitIDFilter$outboundSchema = exports.QueryParamBenefitIDFilter$inboundSchema = exports.ProductsListQueryParamOrganizationIDFilter$ = exports.ProductsListQueryParamOrganizationIDFilter$outboundSchema = exports.ProductsListQueryParamOrganizationIDFilter$inboundSchema = void 0;
...
exports.queryParamBenefitIDFilterToJSON = queryParamBenefitIDFilterToJSON;
exports.queryParamBenefitIDFilterFromJSON = queryParamBenefitIDFilterFromJSON;
...
/** @internal */
exports.QueryParamBenefitIDFilter$inboundSchema = z.union([z.string(), z.array(z.string())]);
/** @internal */
exports.QueryParamBenefitIDFilter$outboundSchema = z.union([z.string(), z.array(z.string())]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var QueryParamBenefitIDFilter$;
(function (QueryParamBenefitIDFilter$) {
    /** @deprecated use `QueryParamBenefitIDFilter$inboundSchema` instead. */
    QueryParamBenefitIDFilter$.inboundSchema = exports.QueryParamBenefitIDFilter$inboundSchema;
    /** @deprecated use `QueryParamBenefitIDFilter$outboundSchema` instead. */
    QueryParamBenefitIDFilter$.outboundSchema = exports.QueryParamBenefitIDFilter$outboundSchema;
})(QueryParamBenefitIDFilter$ || (exports.QueryParamBenefitIDFilter$ = QueryParamBenefitIDFilter$ = {}));
function queryParamBenefitIDFilterToJSON(queryParamBenefitIDFilter) {
    return JSON.stringify(exports.QueryParamBenefitIDFilter$outboundSchema.parse(queryParamBenefitIDFilter));
}
function queryParamBenefitIDFilterFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.QueryParamBenefitIDFilter$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'QueryParamBenefitIDFilter' from JSON`);
}
/** @internal */
