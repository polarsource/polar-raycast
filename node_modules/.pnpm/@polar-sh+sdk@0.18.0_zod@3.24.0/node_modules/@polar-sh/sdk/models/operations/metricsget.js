...
exports.MetricsGetRequest$ = exports.MetricsGetRequest$outboundSchema = exports.MetricsGetRequest$inboundSchema = exports.MetricsGetQueryParamProductPriceTypeFilter$ = exports.MetricsGetQueryParamProductPriceTypeFilter$outboundSchema = exports.MetricsGetQueryParamProductPriceTypeFilter$inboundSchema = exports.MetricsGetQueryParamProductIDFilter$ = exports.MetricsGetQueryParamProductIDFilter$outboundSchema = exports.MetricsGetQueryParamProductIDFilter$inboundSchema = exports.MetricsGetQueryParamOrganizationIDFilter$ = exports.MetricsGetQueryParamOrganizationIDFilter$outboundSchema = exports.MetricsGetQueryParamOrganizationIDFilter$inboundSchema = void 0;
...
exports.metricsGetQueryParamProductPriceTypeFilterToJSON = metricsGetQueryParamProductPriceTypeFilterToJSON;
exports.metricsGetQueryParamProductPriceTypeFilterFromJSON = metricsGetQueryParamProductPriceTypeFilterFromJSON;
...
/** @internal */
exports.MetricsGetQueryParamProductPriceTypeFilter$inboundSchema = z.union([
    components.ProductPriceType$inboundSchema,
    z.array(components.ProductPriceType$inboundSchema),
]);
/** @internal */
exports.MetricsGetQueryParamProductPriceTypeFilter$outboundSchema = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var MetricsGetQueryParamProductPriceTypeFilter$;
(function (MetricsGetQueryParamProductPriceTypeFilter$) {
    /** @deprecated use `MetricsGetQueryParamProductPriceTypeFilter$inboundSchema` instead. */
    MetricsGetQueryParamProductPriceTypeFilter$.inboundSchema = exports.MetricsGetQueryParamProductPriceTypeFilter$inboundSchema;
    /** @deprecated use `MetricsGetQueryParamProductPriceTypeFilter$outboundSchema` instead. */
    MetricsGetQueryParamProductPriceTypeFilter$.outboundSchema = exports.MetricsGetQueryParamProductPriceTypeFilter$outboundSchema;
})(MetricsGetQueryParamProductPriceTypeFilter$ || (exports.MetricsGetQueryParamProductPriceTypeFilter$ = MetricsGetQueryParamProductPriceTypeFilter$ = {}));
function metricsGetQueryParamProductPriceTypeFilterToJSON(metricsGetQueryParamProductPriceTypeFilter) {
    return JSON.stringify(exports.MetricsGetQueryParamProductPriceTypeFilter$outboundSchema.parse(metricsGetQueryParamProductPriceTypeFilter));
}
function metricsGetQueryParamProductPriceTypeFilterFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.MetricsGetQueryParamProductPriceTypeFilter$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'MetricsGetQueryParamProductPriceTypeFilter' from JSON`);
}
/** @internal */
