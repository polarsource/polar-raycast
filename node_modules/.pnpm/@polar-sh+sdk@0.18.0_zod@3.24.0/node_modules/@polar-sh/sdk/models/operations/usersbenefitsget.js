...
exports.usersBenefitsGetRequestToJSON = usersBenefitsGetRequestToJSON;
exports.usersBenefitsGetRequestFromJSON = usersBenefitsGetRequestFromJSON;
exports.usersBenefitsGetResponseUsersBenefitsGetToJSON = usersBenefitsGetResponseUsersBenefitsGetToJSON;
exports.usersBenefitsGetResponseUsersBenefitsGetFromJSON = usersBenefitsGetResponseUsersBenefitsGetFromJSON;
...
function usersBenefitsGetRequestToJSON(usersBenefitsGetRequest) {
    return JSON.stringify(exports.UsersBenefitsGetRequest$outboundSchema.parse(usersBenefitsGetRequest));
}
function usersBenefitsGetRequestFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.UsersBenefitsGetRequest$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UsersBenefitsGetRequest' from JSON`);
}
/** @internal */
...
function usersBenefitsGetResponseUsersBenefitsGetToJSON(usersBenefitsGetResponseUsersBenefitsGet) {
    return JSON.stringify(exports.UsersBenefitsGetResponseUsersBenefitsGet$outboundSchema.parse(usersBenefitsGetResponseUsersBenefitsGet));
}
function usersBenefitsGetResponseUsersBenefitsGetFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.UsersBenefitsGetResponseUsersBenefitsGet$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UsersBenefitsGetResponseUsersBenefitsGet' from JSON`);
}
