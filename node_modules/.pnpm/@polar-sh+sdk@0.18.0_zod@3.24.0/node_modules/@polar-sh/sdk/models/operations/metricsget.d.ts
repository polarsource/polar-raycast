...
export declare function metricsGetQueryParamProductPriceTypeFilterToJSON(metricsGetQueryParamProductPriceTypeFilter: MetricsGetQueryParamProductPriceTypeFilter): string;
export declare function metricsGetQueryParamProductPriceTypeFilterFromJSON(jsonString: string): SafeParseResult<MetricsGetQueryParamProductPriceTypeFilter, SDKValidationError>;
/** @internal */
