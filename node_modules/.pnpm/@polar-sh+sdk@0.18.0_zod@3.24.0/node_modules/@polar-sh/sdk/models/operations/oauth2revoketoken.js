...
exports.oauth2RevokeTokenRevokeTokenRequestToJSON = oauth2RevokeTokenRevokeTokenRequestToJSON;
exports.oauth2RevokeTokenRevokeTokenRequestFromJSON = oauth2RevokeTokenRevokeTokenRequestFromJSON;
...
function oauth2RevokeTokenRevokeTokenRequestToJSON(oauth2RevokeTokenRevokeTokenRequest) {
    return JSON.stringify(exports.Oauth2RevokeTokenRevokeTokenRequest$outboundSchema.parse(oauth2RevokeTokenRevokeTokenRequest));
}
function oauth2RevokeTokenRevokeTokenRequestFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.Oauth2RevokeTokenRevokeTokenRequest$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Oauth2RevokeTokenRevokeTokenRequest' from JSON`);
}
