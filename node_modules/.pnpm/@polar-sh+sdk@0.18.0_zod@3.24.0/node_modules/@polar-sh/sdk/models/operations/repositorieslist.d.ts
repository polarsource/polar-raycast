...
export declare function repositoriesListQueryParamOrganizationIDFilterToJSON(repositoriesListQueryParamOrganizationIDFilter: RepositoriesListQueryParamOrganizationIDFilter): string;
export declare function repositoriesListQueryParamOrganizationIDFilterFromJSON(jsonString: string): SafeParseResult<RepositoriesListQueryParamOrganizationIDFilter, SDKValidationError>;
/** @internal */
