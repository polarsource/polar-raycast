...
export declare function usersBenefitsListRequestToJSON(usersBenefitsListRequest: UsersBenefitsListRequest): string;
export declare function usersBenefitsListRequestFromJSON(jsonString: string): SafeParseResult<UsersBenefitsListRequest, SDKValidationError>;
/** @internal */
...
export declare function usersBenefitsListResponseToJSON(usersBenefitsListResponse: UsersBenefitsListResponse): string;
export declare function usersBenefitsListResponseFromJSON(jsonString: string): SafeParseResult<UsersBenefitsListResponse, SDKValidationError>;
